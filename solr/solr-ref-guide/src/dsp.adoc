...
The functions described earlier in the section of the user guide all operate on signals in time domain. The Discrete
Fourier Transform translates a time domain signal into the frequency domain.
