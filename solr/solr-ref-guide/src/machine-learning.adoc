...
This section of the math expressions user guide covers the machine learning
functions.
...
Standardizing scales a vector so that it has a mean of 0 and a
standard deviation of 1. Standardization can be used with machine
learning algorithms, such as SVM, that
...
Unitizing scales vectors to a magnitude of 1. A vector with a
